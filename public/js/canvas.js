...
function buildGameCanvas(){
	...
	gameData.boardMaskW = 455;
	gameData.boardMaskH = 350;
	var boardMaskRadius = 10;
	boardDrawingMask = new createjs.Shape();
	boardDrawingMask.graphics.beginFill("red").drawRoundRectComplex(-(gameData.boardMaskW/2), -(gameData.boardMaskH/2), gameData.boardMaskW, gameData.boardMaskH, boardMaskRadius, boardMaskRadius, boardMaskRadius, boardMaskRadius);
